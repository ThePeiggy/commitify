...
commitment = Commitment.create(title: "Shave Pei's Head", description: "We're gonna shave Pei.", expiry_date: DateTime.now + 3.days, status: Commitment::READY, cost: 0.004, account_id: "54f289b581878d6e9e00005a")
